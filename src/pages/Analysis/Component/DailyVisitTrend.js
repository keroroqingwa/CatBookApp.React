...
// 查询列表数据url
const queryDataUrl = 'analysis/getAnalysisDailyVisitTrend';
...
class Donut extends React.Component {
  ...
  render() {
    ...
    if (resByDailyVisitTrend && resByDailyVisitTrend.columns) {
      res.data_session_cnt = resByDailyVisitTrend.data_session_cnt
      res.data_visit_pv = resByDailyVisitTrend.data_visit_pv
      res.data_visit_uv = resByDailyVisitTrend.data_visit_uv
      res.data_visit_uv_new = resByDailyVisitTrend.data_visit_uv_new
      res.data_stay_time_uv = resByDailyVisitTrend.data_stay_time_uv
      res.data_stay_time_session = resByDailyVisitTrend.data_stay_time_session
      res.data_visit_depth = resByDailyVisitTrend.data_visit_depth
      res.columns = resByDailyVisitTrend.columns
    }
        ...
        <Row gutter={16}>
          <Col span={24}>
            <div className={styles.p20}>
              ...
              <span className={styles.query_data}>当前查询：{resByDailyVisitTrend && resByDailyVisitTrend.query_data}</span>
            </div>
